...
export default function ApprovedPosts() {
  ...
  return (
    <div className="-md scale-105  -200 -out btn-hover:border space-y-6">
      <div>
        <h1 className="-md scale-105  -200 -out btn-hover:border text-3xl font-bold">Approved Posts</h1>
        <p className="-md scale-105  -200 -out btn-hover:border text-muted-foreground">Manage published blog posts</p>
      </div>

      {posts.length === 0 ? (
        <Card>
          <CardContent className="-md scale-105  -200 -out btn-hover:border pt-6">
            <p className="-md scale-105  -200 -out btn-hover:border text-center text-muted-foreground">No approved posts yet</p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="-md scale-105  -200 -out btn-hover:border flex gap-2">
                    ...
                    >
                      <Link to={`/blog/${post.id}`}>
                        <Eye className="-md scale-105  -200 -out btn-hover:border h-4 w-4" />
                        View Post
                      </Link>
                    </Button>
                    <Button
